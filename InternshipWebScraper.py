# Imported the following libraries: requests, BeautifulSoup and SoupStrainer from bs4, pandas, re and time
...
for query in query_set:
    # Advanced through the results pages by starting at 0 up to the preset limit, and scraping by the number of non-sponsored jobs displayed on each results page on the website
    for start in range(0, max_results_per_query, 10):
        ...
        # Initiated the results page for scraping through the BeautifulSoup package
...
indeedjobsdf.to_csv("/Users/pk/Desktop/IndeedInternships.csv", encoding="utf-8")
